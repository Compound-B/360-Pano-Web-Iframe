(function(global) {
  ...
  */
  ...
  var Tabletop = global.Tabletop = function(options) {
    ...
    this.base_json_url = (this.cached == true) ? "https://www.washingtonpost.com/apps/national/proxy/google/spreadsheet/" + this.key + "/od6/?alt=json-in-script&json.wrf=" + this.customCallback : "https://spreadsheets.google.com/feeds/worksheets/" + this.key + "/public/basic?alt=json-in-script";
